        ...
        <div class="container mx-auto px-4">
          <div class="mx-auto max-w-2xl text-center">
            <h1 class="mb-6 text-4xl font-bold">
              We are building all-in pricing components for the web
            </h1>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="mb-8 w-full px-4 md:w-1/3">
              <div class="rounded-md bg-white p-8 shadow-md">
                ...
                <h3 class="mb-4 text-2xl font-bold">Web integration</h3>
                <p class="mb-4 text-gray-600">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
                  nec orci quis justo aliquam euismod eget a leo.
                </p>
            ...
            <div class="mb-8 w-full px-4 md:w-1/3">
              <div class="rounded-md bg-white p-8 shadow-md">
                ...
                <h3 class="mb-4 text-2xl font-bold">Insights</h3>
                <p class="mb-4 text-gray-600">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
                  nec orci quis justo aliquam euismod eget a leo.
                </p>
